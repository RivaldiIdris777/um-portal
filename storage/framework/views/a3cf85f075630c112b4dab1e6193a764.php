<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="<?php echo e(route('alurpendaftaran.index')); ?>"><i class="bx bx-right-arrow-alt"></i>Sarjana/Pascasarjana</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="<?php echo e(url('rplgambar')); ?>"><i class="bx bx-right-arrow-alt"></i>Alur Pendaftaran Slider/Gambar</a>
                </li>
                <li> <a href="<?php echo e(url('rplbiayapendaftaran')); ?>"><i class="bx bx-right-arrow-alt"></i>Biaya Pendaftaran</a>
                </li>
                <li> <a href="<?php echo e(url('rplbiayaperkuliahan')); ?>"><i class="bx bx-right-arrow-alt"></i>Biaya Perkuliahan</a>
                </li>
