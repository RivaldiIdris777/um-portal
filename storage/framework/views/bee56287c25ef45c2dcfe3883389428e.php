    ...
    <div class="card radius-10">
        <div class="card-body">
            <div>
                ...
                <form action="<?php echo e(route('akreditasi.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Upload Gamabar Bukti Akreditasi</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Folder_project\Laravel_project\homepageum\resources\views/admin/akreditasi/create.blade.php ENDPATH**/ ?>