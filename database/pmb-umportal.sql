...
--
-- Host: localhost:3306
-- Generation Time: Jan 22, 2024 at 05:40 PM
...
(25, '2023_10_13_080848_create_tb_rplslider_table', 21),
(26, '2023_10_13_081035_create_tb_rplbiayapendaftaran_table', 21),
(28, '2023_10_19_073607_create_tb_rplbiayaperkuliahan_table', 22);
...
(18, 'sarjana', 'Y8AvgAer9bdqYjno8huGvkiuepaXrH4gugwcAk5B.jpg', 'Alur Pendaftaran Sarjana', '<p>-</p>', NULL, NULL);
...
(2, 'Biaya Perkuliahan 2024', 'sw7lLMqQ2LJ54sIa6NdZXJ1ayThEb7gdhWt1BydW.jpg', '<p>-</p>', NULL, NULL);
...
(3, 'Brosur Depan', 'w0Wzt9ypFec5zwzYnKFreqXS86oBKdhNUvMs0lwJ.png', '<p>-</p>', NULL, NULL),
(4, 'Brosur Belakang', 'AaO8YknD5HIQsbOPYC5lhL1ARYW0FWgKhYVQVTl7.png', '<p>-</p>', NULL, NULL);
...
(4, 'Data Pengumuman kelulusan PMB 2023 Gel IV', 'Data Pengumuman kelulusan PMB 2023 Gel IV-1703594597.pdf', '<p>-</p>', NULL, NULL);
...
(4, 'Jadwal Pendaftaran', 'BuoNkXdImSzsXw18QA2NX2JPkANYsW81TbSWXhZD.png', NULL, NULL);
...
--
-- Table structure for table `tb_rplbiayapendaftaran`
--

CREATE TABLE `tb_rplbiayapendaftaran` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `program` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `biayapendaftaran` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tb_rplbiayapendaftaran`
--

INSERT INTO `tb_rplbiayapendaftaran` (`id`, `program`, `biayapendaftaran`, `created_at`, `updated_at`) VALUES
(1, 'Ekonomi Pembangunan', '250000', NULL, NULL),
(2, 'Manajemen', '250000', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tb_rplbiayaperkuliahan`
--

CREATE TABLE `tb_rplbiayaperkuliahan` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `program` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `biayapendidikan` int(11) NOT NULL,
  `biayarekognisi` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `tb_rplbiayaperkuliahan`
--

INSERT INTO `tb_rplbiayaperkuliahan` (`id`, `program`, `biayapendidikan`, `biayarekognisi`, `created_at`, `updated_at`) VALUES
(1, 'Ekonomi Pembangunan', 3250000, 45000, NULL, NULL),
(2, 'Manajemen', 3250000, 45000, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tb_rplslider`
--

CREATE TABLE `tb_rplslider` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `judul` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gambar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `tb_rplslider`
--

INSERT INTO `tb_rplslider` (`id`, `judul`, `gambar`, `keterangan`, `created_at`, `updated_at`) VALUES
(1, 'Alur', '0h4CvHyhPV3Y8LGKxDydhA6Qe0BZuNcqs7kIQNl9.png', '<p>-</p>', NULL, NULL);
...
(1, 'mjumain', 'mjumain11@gmail.com', '2023-08-27 20:20:14', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'jPJGcsV2cTR7sMAANNJ82GHHm9dxaMVGBCqHS9QHojjThwbEwBbVqmcjolCy', '2023-08-27 20:20:14', '2023-08-27 20:20:14'),
...
--
-- Indexes for table `tb_rplbiayapendaftaran`
--
ALTER TABLE `tb_rplbiayapendaftaran`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_rplbiayaperkuliahan`
--
ALTER TABLE `tb_rplbiayaperkuliahan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tb_rplslider`
--
ALTER TABLE `tb_rplslider`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_rplbiayapendaftaran`
--
ALTER TABLE `tb_rplbiayapendaftaran`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_rplbiayaperkuliahan`
--
ALTER TABLE `tb_rplbiayaperkuliahan`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_rplslider`
--
ALTER TABLE `tb_rplslider`
