...
<style>
    #heropascasarjana {
        width: 100%;
        height: 80vh;
        background: url("{{ asset('') }}rpl-slider.png") top center;
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <a href="{{ asset('') }}pdf/UU-Nomor-12-Tahun-2012.pdf">
                                    <div class="card-body text-center">
                                        <img class="text-center" src="{{ asset('') }}lawicon.png" alt="" width="200"
                                            height="180">
                                        <br><br>
                            ...
                            <div class="col-md-3">
                                <a href="{{ asset('') }}pdf/permendikbud-no-3-2020.pdf">
                                    <div class="card-body text-center">
                                        <img class="text-center" src="{{ asset('') }}lawicon.png" alt="" width="200"
                                            height="180">
                                        <br><br>
                            ...
                            <div class="col-md-3">
                                <a href="{{ asset('') }}pdf/Permendikbudristek_Nomor_41_Tahun_2021.pdf">
                                    <div class="card-body text-center">
                                        <img class="text-center" src="{{ asset('') }}lawicon.png" alt="" width="200"
                                            height="180">
                                        <br><br>
                            ...
                            <div class="col-md-3">
                                <a href="{{ asset('') }}pdf/Kepdirjen_Diktiristek_No_162.pdf">
                                    <div class="card-body text-center">
                                        <img class="text-center" src="{{ asset('') }}lawicon.png" alt="" width="200"
                                            height="180">
                                        <br><br>
